  ...
  return (
   ...
   <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24 bg-black">
     ...
     {alertVisible && (
       ...
       <p className="mt-4 text-yellow-500"   style={{ fontFamily: 'Bona Nova'}}>
     ...
     <form onSubmit={handleLogin} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
       ...
       <div>
         <label htmlFor="password" className="sr-only"   style={{ fontFamily: 'Bona Nova'}}>Password</label>
       ...
       {error ? <p className='text-red-600'   style={{ fontFamily: 'Bona Nova'}}> Email or Password is not correct!</p>: ""}
 
       <div className="flex items-center justify-between">
         <p className="text-sm text-gray-50"   style={{ fontFamily: 'Bona Nova'}}>
Don't you have an account?<Link to='/sign-up' className='text-yellow-400 hover:text-yellow-200'> Create an account</Link>
<hr/>
 <div>
